...
public class GamePanel extends JPanel implements Runnable {
    ...
    public static final int MODIFIED_TILE_SIZE = ORGINAL_TILE_SIZE * SCALE; // 96 x 96 tiles
    public static final int SCREEN_COL = 16; //1536
    public static final int SCREEN_ROW = 9; // 896

    public static final int SCREEN_WIDTH = SCREEN_COL * MODIFIED_TILE_SIZE;
    public static final int SCREEN_HEIGHT = SCREEN_ROW * MODIFIED_TILE_SIZE;
